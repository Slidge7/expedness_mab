...
export const CreateMarqueScreen = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert(t('common.success'), t('marques.create_success'));
      navigation.goBack();
    } catch (error: any) {
      Alert.alert(
        t('common.error'),
        error.response?.data?.message || error.message || t('marques.create_failed'),
      );
    } finally {
      setLoading(false);
    }
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 20 }}>
      ...
      <TextInput
        ...
        placeholder={t('marques.title_placeholder')}
      />
      ...
      <TextInput
        ...
        placeholder={t('marques.type_placeholder')}
      />
      ...
      <TextInput
        ...
        placeholder={t('marques.description_placeholder')}
        multiline
      />
      ...
      <TextInput
        ...
        placeholder={t('marques.metadata_placeholder')}
        multiline
        autoCapitalize="none"
      />
      {metadataError ? (
